...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .patient-info, .doctor-info { display: flex; align-items: center; gap: 0.75rem; }
        ...
        .details h4 { font-weight: 600; margin-bottom: 0.25rem; font-size: 0.875rem; }
                        ...
                        <tbody>
                            ...
                            <?php foreach ($appointments as $appointment): ?>
                                <tr>
                                    ...
                                    <td>K<?php echo number_format($appointment['fees'], 2); ?></td>
                                    <td>
                                        <?php
