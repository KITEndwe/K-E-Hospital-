...
<head>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .nav-item.active { background:#eef2ff; color:#3b82f6; border-right-color:#3b82f6; }
        ...
        .top-bar {
            ...
            border:1px solid #e2e8f0; flex-wrap:wrap; gap:1rem;
        }
        ...
        .logout-btn {
            background:#ef4444; color:white; padding:0.5rem 1.25rem;
            border-radius:0.5rem; text-decoration:none; font-size:0.875rem;
            font-weight:500; transition:all 0.3s; display:inline-flex; align-items:center; gap:0.5rem;
        }
        ...
        .reset-btn {
            ...
            text-decoration:none; border-radius:0.5rem; font-size:0.875rem;
            display:inline-flex; align-items:center; gap:0.5rem;
        }

        /* ── Table ── */
        .table-container { background:white; border-radius:1rem; overflow:hidden; border:1px solid #e2e8f0; }
        .appointments-table { overflow-x:auto; -webkit-overflow-scrolling:touch; }
        table { width:100%; border-collapse:collapse; }
        th {
            text-align:left; padding:1rem; background:#f8fafc;
            font-weight:600; font-size:0.875rem; color:#475569;
            border-bottom:1px solid #e2e8f0;
        }
        td { padding:1rem; border-bottom:1px solid #f1f5f9; font-size:0.875rem; vertical-align:middle; }
        ...
        .avatar {
            ...
            justify-content:center; color:#3b82f6; font-weight:600;
            overflow:hidden; flex-shrink:0; border:2px solid #e0e7ff;
        }
        .avatar img {
        ...
        .person-details h4 { font-weight:600; font-size:0.875rem; color:#0f172a; margin-bottom:0.2rem; }
        .person-details p  { font-size:0.75rem; color:#64748b; }
        ...
        .pay-refunded{ background:#fee2e2; color:#dc2626; }

        /* ── Action buttons ── */
        .action-buttons { display:flex; gap:0.5rem; }
        .action-btn {
            background:none; border:none; cursor:pointer;
            font-size:1rem; padding:0.3rem 0.5rem; border-radius:0.375rem; transition:all 0.2s;
            color:#3b82f6;
        }
        ...
        .mobile-menu-toggle {
            ...
            width:40px; height:40px; border-radius:0.5rem; font-size:1.25rem;
